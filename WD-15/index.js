...
abc().then(res=>console.log(res)).catch(err=>console.log(err))
...
const p1 = new Promise((resolve) =>
    ...
    // task-1 make maggi process
     
    async function myAsyncFunction() {
      return "Hello, world!";
    }
    console.log(myAsyncFunction());
    // Output: Promise {<resolved>: "Hello, world!"}
